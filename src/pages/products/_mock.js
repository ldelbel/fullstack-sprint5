...
export const appMock = {
  withoutFilter: {
    filterValue: mock.filterContextValue.empty,
    loadingValue: mock.loadingContextValue,
    messageValue: mock.messageContextValue,
  },
  withFilter: {
    filterValue: mock.filterContextValue.notEmpty,
    loadingValue: mock.loadingContextValue,
    messageValue: mock.messageContextValue,
  },
};
